...
execute unless score @s bp.brine_map_acquired matches 1.. if block ~ ~0 ~ conduit run function bracken:dimension_commands/other/give_brine_map
execute unless score @s bp.brine_map_acquired matches 1.. if block ~ ~-1 ~ conduit run function bracken:dimension_commands/other/give_brine_map
