...
execute unless predicate bracken:has_water_breathing unless predicate bracken:in_boat unless predicate bracken:in_chest_boat if block ~ ~ ~ minecraft:water run effect give @s minecraft:wither 1 1 false
execute unless predicate bracken:has_water_breathing unless predicate bracken:in_boat unless predicate bracken:in_chest_boat if block ~ ~ ~ #bracken:waterloggable[waterlogged=true] run effect give @s minecraft:wither 1 1 true
...
execute unless predicate bracken:has_water_breathing positioned over motion_blocking if entity @s[dy=999,predicate=bracken:rain] run function bracken:player/species/netherkin/rain
